...
<Layout>
  <div class="card">
    ...
    <ul style="margin-left: 2rem; line-height: 2;">
      ...
      <li>
        <strong>Custom Parameters:</strong> Flexible parameter naming (slug, orderId,
        etc.)
      </li>
      <li>
    ...
    <p style="margin: 1rem 0;">
      Explore the site to see all these features in action. You can browse
      books, create an account, add items to your cart, and even access the
      admin panel (login as admin@bookstore.com / admin123).
    </p>
